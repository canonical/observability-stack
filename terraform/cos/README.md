...
| <a name="input_ingress"></a> [ingress](#input\_ingress) | Per-application toggle for Traefik ingress integration | <pre>object({<br/>    alertmanager = optional(bool, true)<br/>    catalogue    = optional(bool, true)<br/>    grafana      = optional(bool, true)<br/>    loki         = optional(bool, true)<br/>    mimir        = optional(bool, true)<br/>    tempo        = optional(bool, true)<br/>  })</pre> | `{}` | no |

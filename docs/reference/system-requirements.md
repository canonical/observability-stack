...
```{math}
\text{disk (GiB/day)} = 3.011 \cdot 10^{-4} L + 3.823 \cdot 10^{-6} M + 1.023
```

```{math}
\text{vCPUs} = 1.89 \arctan(1.365 \cdot 10^{-4} L) + 1.059 \cdot 10^{-7} M + 1.644
```

```{math}
\text{mem (GB)} = 2.063 \arctan(2.539 \cdot 10^{-3} L) + 1.464 \cdot 10^{-6} M + 3.3
```

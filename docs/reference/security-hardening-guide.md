...
* allowing applications to send metrics to COS when COS is deployed on a different substrate (as recommended by the [COS deployment best practices guide](https://documentation.ubuntu.com/observability/track-2/reference/best-practices/topology/#deploy-in-isolation) 

...
| [Mimir Worker](https://charmhub.io/mimir-worker-k8s)                     | Yes | K8s       | 2.17             | 2.17  | [Source](https://github.com/canonical/mimir-operators/tree/main/worker), [issues](https://github.com/canonical/mimir-operators/issues)                    |
...
| [SNMP Exporter](https://charmhub.io/prometheus-snmp-exporter)                                | Yes | Machines  | 0.24             | 0.24  | [Source](https://github.com/canonical/snmp-exporter-operator), [issues](https://github.com/canonical/snmp-exporter-operator/issues)                                           |

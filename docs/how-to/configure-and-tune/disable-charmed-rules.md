...
Alertmanager can be [configured](https://prometheus.io/docs/alerting/latest/configuration/) to silence alerts by labels. This can be used to silence all alerts that contain juju topology labels, for example:

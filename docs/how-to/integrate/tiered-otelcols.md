...
To understand how to filter telemetry with otelcol, refer to the [selectively drop telemetry](../configure-and-tune/selectively-drop-telemetry-otelcol) documentation or see the [examples for log-level filtering](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/processor/filterprocessor/testdata/config_logs_min_severity.yaml).
...
```{literalinclude} /how-to/integrate/tiered-outgoing-otelcol-bundle.yaml
:lines: 3, 10-18
```
...
```{literalinclude} /how-to/integrate/tiered-incoming-otelcol-bundle.yaml
:lines: 3, 10-16
```

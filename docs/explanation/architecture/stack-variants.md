...
| Minimum system requirements | 1x 8cpu16gb + storage nodes ([details][sysreqs])  | 1x 4cpu8gb (+storage nodes, if any) ([details][sysreqs])                  |
...
[Opentelemetry Collector](https://charmhub.io/opentelemetry-collector-k8s), to observe applications
...
access to the stack both for users, and for Opentelemetry Collectors that want to send
over telemetry.
...
#### [Opentelemetry Collector for Kubernetes](https://charmhub.io/opentelemetry-collector-k8s)

The Opentelemetry Collector charmed operator for Kubernetes provides a way to fetch and
forward telemetry, alert rules, and dashboards via Juju relations, and send
them over to the observability stack.


#### [Opentelemetry Collector for Machines](https://charmhub.io/opentelemetry-collector)

The Opentelemetry Collector charmed operator for Machines provides a way to fetch and
...
Opentelemetry Collector and the charm you want to scrape.

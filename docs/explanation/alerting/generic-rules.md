...
This guide explains the purpose of each rule group and its alerts. For steps to troubleshoot firing alert rules, refer to the [troubleshooting guide](../../how-to/validate-and-troubleshoot/troubleshooting).
